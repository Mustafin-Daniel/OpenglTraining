...
public class SolarSystemRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
                ...
                sphere1 = new Sphere(0.0f, 0.0f, -0.5f, 0.3f);
                sphere2 = new Sphere(1.0f, 0.0f, -0.5f, 0.05f);
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        sphere1.draw(MVMatrix,MVPMatrix,lightPosInEyeSpace,new float[]{1.0f,0.7f,0.0f,1.0f});
        sphere2.draw(MVMatrix,MVPMatrix,lightPosInEyeSpace,new float[]{0.0f,0.0f,1.0f,1.0f});
    }
